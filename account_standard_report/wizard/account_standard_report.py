...
class AccountStandardLedger(models.TransientModel):
    ...
    # analytic_account_ids = fields.Many2many('account.analytic.account', string="Analytic Account in report")
    ...
    def _pre_compute(self):
        ...
        self.analytic_account_select_ids = self._search_analytic_account()
    ...
    def _sql_report_object(self):
        ...
        params = [
            ...
            tuple(self.analytic_account_select_ids.ids) if self.analytic_account_select_ids else (None,),
        ]
